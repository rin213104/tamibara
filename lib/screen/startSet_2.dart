      ...
      home: Scaffold(
        body: Container(
          ...
          child: Column(
            children: [
              Expanded(
                child: SingleChildScrollView( // 스크롤 가능한 화면 > 키보드가 올라왔을 때 화면 깨짐 방지
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: screenHeight * 0.35), // 위 아래 여백 조절
                      ],
                    ),
                  ),
                ),
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      children: [
          ...
          child: Container(
            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                ...
                hintText: _focusNode.hasFocus ? null : '닉네임을 입력하세요', // 글자 없으면 텍스트 표시
        ...
        if (_textController.text.isNotEmpty) // 글자가 존재할 때만
          IconButton( // 다음 화면으로 넘어가는 화살표 버튼
