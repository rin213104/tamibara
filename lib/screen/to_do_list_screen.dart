...
import 'package:timer/model/gaming_data_model.dart';
...
class _setToDoScreenState extends State<ToDoScreen> {
  ...
  void _handleToDoChecked(bool isChecked, int index) {
    if (isChecked) {
      ...
      // 체크박스 상태 변경 시 랜덤 메시지 출력
      _showRandomToast();
      // 체크 박스 상태 변경 시 경험치 증가
      Provider.of<GamingDataModel>(context, listen: false).increaseCheckedEXP();
    }
  }
